...
module load cuda/12.9 # this will set $CUDA_HOME
...
submission=reference_algorithms/muon_def/pytorch/muon_kj_overlapped_reduce_scatter.py
search_space=script/tune/search_spaces/debug.json
num_tuning_trials=1
study=1
name=debug_01
rng_seed=1996
