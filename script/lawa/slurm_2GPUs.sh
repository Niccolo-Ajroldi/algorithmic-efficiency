...
# search_space=script/lawa/nadam/nadamw_trial_3_lr_sweep.json
# num_tuning_trials=5
# study=3
# name=lr_sweep_nadamw_02

## EMA
submission=submissions/lawa_ema/lawa_ema.py
search_space=script/lawa/ema/lawa_trial_3_lr_sweep_01.json
num_tuning_trials=5
study=1
