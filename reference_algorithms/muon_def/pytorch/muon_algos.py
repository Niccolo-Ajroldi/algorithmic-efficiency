...
We provide two implementations:``MuonSingleDevice`` and ``MuonDataParallel``.
The first one expects all-reduced gradients, and replicates the parameter update across devices.
