""""
``MuonSingleDevice``, see the corresponding algorithm in `muon_algos.py` for more details.
"""
...
from reference_algorithms.muon_def.pytorch.muon_algos import MuonSingleDevice
