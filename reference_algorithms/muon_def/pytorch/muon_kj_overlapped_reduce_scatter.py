""""
``MuonDataParallel``, see the corresponding algorithm in `muon_algos.py` for more details.
"""
...
from reference_algorithms.muon_def.pytorch.muon_algos import MuonDataParallel
from reference_algorithms.muon_def.pytorch.utils import _split_params_muon_adam
...
def update_params(
  ...
  # TODO: move clipping INSIDE the optimizer!
  if grad_clip is not None and grad_clip != 0:
    raise NotImplementedError('Grad clipping not implemented for MuonDataParallel.')
