...
def update_params(workload: spec.Workload,
  ...
  steps_per_call = steps_per_eval * 1.05

  # TODO: maybe from scheduler?
  local_step = optimizer_state['step']

  # Discard average and load previous params
  if local_step > lawa_start_step and queue.full():
  ...
  for _ in range(steps_per_call):
    ...
    if hasattr(hyperparameters, 'grad_clip'): # TODO: remove
    ...
    if grad_clip is not None: # TODO: remove
